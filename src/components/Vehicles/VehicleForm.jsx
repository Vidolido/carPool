					...
					<div className='flex gap-2'>
						...
						<label className='flex flex-col'>
							...
							<input
								...
								defaultValue={
									vehicle ? vehicle?.registration?.next.split('T')[0] : ''
								}
								className='border-2 border-grey-50 border-opacity-60 rounded px-2 py-[1px] hover:border-red-200 focus:outline-none'
							/>
						</label>
						...
						<div className='flex gap-2'>
							...
							<label className='flex flex-col'>
								...
								<input
									...
									defaultValue={
										vehicle ? vehicle?.service?.small?.date.split('T')[0] : ''
									}
									className='border-2 border-grey-50 border-opacity-60 rounded px-2 py-[1px] hover:border-red-200 focus:outline-none'
								/>
							</label>
						...
						<div className='flex gap-2'>
							...
							<label className='flex flex-col'>
								...
								<input
									...
									name='bigServiceDate'
									defaultValue={
										vehicle ? vehicle?.service?.big?.date.split('T')[0] : ''
									}
									className='border-2 border-grey-50 border-opacity-60 rounded px-2 py-[1px] hover:border-red-200 focus:outline-none'
								/>
							</label>
					...
					<div className='flex gap-2'>
						<label className='flex flex-col'>
							...
							<input
								...
								defaultValue={
									vehicle ? vehicle?.tireChange?.summer.split('T')[0] : 0
								}
								className='border-2 border-grey-50 border-opacity-60 rounded px-2 py-[1px] hover:border-red-200 focus:outline-none'
							/>
						</label>
						<label className='flex flex-col'>
							...
							<input
								...
								defaultValue={
									vehicle ? vehicle?.tireChange?.winter.split('T')[0] : 0
								}
								className='border-2 border-grey-50 border-opacity-60 rounded px-2 py-[1px] hover:border-red-200 focus:outline-none'
							/>
						</label>
